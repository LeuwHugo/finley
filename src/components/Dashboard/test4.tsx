...
const Test4Container = styled.div`
  grid-column: 6 / 16; /* S'étend de la colonne 1 à 6 */
  grid-row: 5 / 9; /* S'étend de la ligne 4 à 7 */
  display: flex;
...
const Test4: React.FC = () => {
  return (
    <Test4Container>
      <Test4Title>Total Balance</Test4Title>
      <Test4Value>$240,399</Test4Value>
